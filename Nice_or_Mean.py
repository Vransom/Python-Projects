...
#Purpose:  The Tech Academy-Python Course. Demonstrating how to pass variables from
...
def nice_mean(nice,mean,name):
    ...
    while stop:
        ...
        if pick=="n":
            print("\nThe stranger gives you a flower.")
            nice=(nice+1)
            stop=False
        if pick=="m":
            print("\nThe stranger screams at you and \nthrows a rock in your direction...")
            mean=(mean+1)
            stop=False
...
def lose(nice,mean,name):
    ...
    print("\nAhh too bad, game over! \n{}, the strangers unite to burn you at the stake!".format(name))
    #call again funcion and pass in our variables
