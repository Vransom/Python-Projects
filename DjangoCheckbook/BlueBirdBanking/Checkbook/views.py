...
def balance(request, pk):
    ...
    current_total = account.initial_deposit #creat account total variable, starting with initial deposit value
...
def transaction(request):
    if request.method == 'POST': #check to see if the submitted form is valid and if so, saves the form
